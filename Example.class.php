...
class Charts {
  ...
  public function getLineChart() {
    ...
    $lineChart->setTitle('text', 'Monthly Average Temperature');
    ...
    $lineChart->setyAxis('title', array('text' => 'Temperature (°C)'));

    // The actual data to be graphed.
    $nycSeries = array('data' =>
         array(-0.2, 0.81, 51.7,
               11.3, 17.0, 22.0,
               24.8, 24.1, 20.1,
               14.1, 8.6, 2.5
    ...
    $lineChart->addSerie('New York', $nycSeries);
    $lineChart->addSerie('Tokyo', $tokyoSerie);
